    ...
    public function getUserdetails()
        ...
        public function checkContactNoExistForUser(Request $req)
        {
            try {
                ...
                //     if (!$msg91AuthKey || !$msg91SendOtpTemplateId) {
                //         return response()->json([
                //             'message' => 'System configuration missing for OTP sending',
                //             'status' => 500,
                //         ], 500);
                //     }
                    
                //     $msg91AuthKey = $msg91AuthKey->value;
                //     $msg91SendOtpTemplateId = $msg91SendOtpTemplateId->value;
    
                //     $payload = [
                //         "template_id" => (string) $msg91SendOtpTemplateId,
                ...
                if (!empty($req->contactNo)) {
                    // STATIC RESPONSE INSTEAD OF CURL
                    $resData = [
                        "type" => "success",
