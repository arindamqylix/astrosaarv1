...
@section('title', 'Free Kundli')
@push('page-css')
<link rel="stylesheet" href="{{ asset('public/assets-front/css/kundli.css') }}" />
...
<!-- ---------------kundili section----------- -->
    <div class="kundli-header-bg" style="margin-top:70px;">
      ...
      <div class="kundli-header-content">
        ...
        <p class="subtitle">Get instant &amp; accurate, Janam Kundli</p>
      </div>
    </div>
    <div class="kundli-content">
      ...
      <div class="kundli-form-section">
        <div class="kundli-form-card">
          <div class="tab-row">
            <div class="tab active">New Kundli</div>
          </div>
          <div class="form-row">
            <form class="kundli-form">
              ...
              <div class="form-group-flex">
                ...
                <div>
                  <label for="birthtime"
                    >Birth Time<span class="required">*</span></label
                  >
        ...
        <div class="kundli-form-card saved-kundli-card">
          <div class="tab-row saved-tabs">
            <div class="tab active">Saved Kundli</div>
          </div>
          <div class="saved-kundli-msg">
            <p>Login to see your<br />saved Kundli</p>
          </div>
        </div>
      </div>
