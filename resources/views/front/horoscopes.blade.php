...
@push('page-css')
<link rel="stylesheet" href="{{ asset('public/assets-front/css/horoscopes.css') }}" />
...
<!-- Example: use server include or copy navbar code if you're not using JS -->
    ...
    <section class="compatibility-header" style="margin-top:70px;">
      <h1>Horoscopes</h1>
      <p>Check your horoscope today</p>
    </section>
    ...
    <section class="compatibility-info">
      ...
      <p>
        Looking for your free kundli? An expert astrologer online now can guide
        you in the right place. The online kundli you receive from AstroSaar
        uses your exact birth information and creates the most accurate chart to
        help make better predictions in love life, marriage, business, career or
        anything troubling your conditions. Our tools are used for purposes like
        matchmaking, kundli matching for marriage, or simply making future
        predictions.
      </p>
    </section>
    ...
    <section class="compatibility-description">
      <p>
        ...
        romantic relationships. You can also find insights on your partner based
        on your sun and moon signs and overall compatibility. This ensures
        better relationships with self-awareness, understanding love sides and
        selecting partners.
      </p>
      <p>
        Your compatibility can also be checked between friends through the
        strength of the number, date of birth or nakshatra. If you're trying to
        figure yourself out, compatibility can give you big clues. You can also
        find out more about your marriage life, relationships or when the right
        time is for you to marry based on compatibility reports.
      </p>
    </section>
