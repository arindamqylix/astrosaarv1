...
@push('page-css')
<link rel="stylesheet" href="{{ asset('public/assets-front/css/compatibility1.css') }}" />
...
@endpush
@section('content')
<!-- Example: use server include or copy navbar code if you're not using JS -->

  <section class="compatibility-header" style="margin-top:70px;">
    <h1>Compatibility</h1>
    <p>Check your love compatibility</p>
  </section>

  <section class="compatibility-info">
    <h2>Free Kundli Online – Get Your Detailed Birth Chart with Predictions</h2>
    <p>
      Looking for your free kundli? An expert astrologer online now can guide you in the right place.
      The online kundli you receive from AstroSaar uses your exact birth information and creates the most
      accurate chart to help make better predictions in love life, marriage, business, career or anything
      troubling your conditions. Our tools are used for purposes like matchmaking, kundli matching for marriage,
      or simply making future predictions.
    </p>
  </section>
  ...
  <section class="compatibility-description">
    <p>
      Zodiac sign compatibility reveals more than just compatibility in romantic relationships.
      You can also find insights on your partner based on your sun and moon signs and overall compatibility.
      This ensures better relationships with self-awareness, understanding love sides and selecting partners.
    </p>
    <p>
      Your compatibility can also be checked between friends through the strength of the number, date of
      birth or nakshatra. If you're trying to figure yourself out, compatibility can give you big clues.
      You can also find out more about your marriage life, relationships or when the right time is for you
      to marry based on compatibility reports.
    </p>
  </section>
  ...
  <section class="choose-sign">
      ...
      <div class="zodiac-grid">
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Aries.jpg') }}" alt="Aries" />
        </div>
        <div class="zodiac-item">
          <img src="{{asset('public/assets-front/image/Taurus.jpg')}}" alt="Taurus" />
        </div>
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Gemini.jpg') }}" alt="Gemini" />
        </div>
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Cancer.jpg') }}" alt="Cancer" />
        </div>
        <div class="zodiac-item"><img src="{{asset('public/assets-front/image/Leo.jpg')}}" alt="Leo" /></div>
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Virgo.jpg') }}" alt="Virgo" />
        </div>
        <div class="zodiac-item">
          <img src="{{asset('public/assets-front/image/Libra.jpg')}}" alt="Libra" />
        </div>
        <div class="zodiac-item">
          <img src="{{asset('public/assets-front/image/Scorpio.jpg')}}" alt="Scorpio" />
        </div>
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Sagittarius.jpg') }}" alt="Sagittarius" />
        </div>
        <div class="zodiac-item">
          <img src="{{asset('public/assets-front/image/Capricorn.jpg')}}" alt="Capricorn" />
        </div>
        <div class="zodiac-item">
          <img src="{{asset('public/assets-front/image/Aquarius.jpg')}}" alt="Aquarius" />
        </div>
        <div class="zodiac-item">
          <img src="{{ asset('public/assets-front/image/Pisces.jpg') }}" alt="Pisces" />
        </div>
      </div>
    </section>
