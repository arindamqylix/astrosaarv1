...
<div class="astroway-footer">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="{{route('front.astrologers.getBlog')}}" class="font-14 color-pink-light">Blog</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-3">
                            ...
                            <p class="mb-2">
                                <a href="{{route('front.astrologers.privacyPolicy')}}" class="font-14 text-white">Privacy policy</a>
                            </p>
                            <p class="mb-2">
                                <a href="{{route('front.astrologers.termscondition')}}" class="font-14 text-white">Terms Of Use</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-3 offset-md-1 offset-lg-0 pl-md-4">
                    ...
                    <div class="d-flex d-md-block">
                        <div class="my-2">
                            <a href="javascript:void(0);" rel="nofollow noopener noreferrer" style="position: relative; display: inline-block;">
                                <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/google-play.png')}}"
                        ...
                        <div class="my-2 ml-2 ml-md-0">
                            <a href="javascript:void(0);" rel="nofollow noopener noreferrer" style="position: relative; display: inline-block;">
                                <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/app-store.png')}}"
                    ...
                    <div class="d-flex mt-2 flex-wrap">
                        <a class="mr-2 mt-2" target="_blank" href="{{$facebook->value ?? '#'}}" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/fb.svg')}}"
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="#" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/twitter.svg')}}"
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="{{$linkedIn->value ?? '#'}}" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/linkedin.svg')}}"
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="{{$instagram->value ?? '#'}}" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/insta.svg')}}"
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="{{$youtube->value ?? '#'}}" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/youtube.svg')}}"
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="{{$pintrest->value ?? '#'}}" rel="nofollow" style="position: relative; display: inline-block;">
                            <img src="{{asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/pinterest.svg')}}"
    ...
    <div class="bg-brown-dark copyright" style="background-color: #5a3aa0 !important;">
        <div class="container py-3">
            <p class="text-center text-white mb-1">Copyright &copy; 2020-{{date('Y')}} {{ $appName }}. All Rights Reserved</p>
        </div>
    </div>
</div>
