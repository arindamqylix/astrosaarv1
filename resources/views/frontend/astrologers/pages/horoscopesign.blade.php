        ...
        <div class="container">
            ...
            <div class="zodiac-grid">
                ...
                <a href="{{route('front.dailyHoroscope',['horoscopeSignId' => $horoscopesign['id']])}}"
                    title="{{$horoscopesign['name']}}" class="zodiac-card">
                    @php
                    ...
                    @if($hasImage)
                        ...
                        <div class="zodiac-placeholder" style="display: none;">{{ $firstLetter }}</div>
                    @else
                        <div class="zodiac-placeholder">{{ $firstLetter }}</div>
                    @endif
                    <h3>{{$horoscopesign['name']}}</h3>
                </a>
                @endforeach
            </div>
        </div>
            ...
            <div class="banner-section">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <a href="{{route('front.chatList')}}" class="btn">
                            <i class="fas fa-comments mr-2"></i> Ask An Astrologer Now
                        </a>
                    </div>
                    <div class="col-md-4 text-center d-none d-md-block">
                        <img src="{{asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/success-future.png')}}" 
