            ...
            <div class="row">
                                            ...
                                            @else
                                                <div id="imagePreviewContainer" style="display: none;" class="text-center">
                                                    <img id="imagePreview" src="#" alt="Profile Image Preview" class="profile-image-preview"
                                                        onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                                    <div class="image-placeholder" style="display: none;">
                                                        {{ strtoupper(substr($getAstrologer['recordList'][0]['name'] ?? 'U', 0, 1)) }}
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="radio-group">
                                            <div class="radio-option">
                                                <input type="radio" id="working-yes" name="isWorkingOnAnotherPlatform" value="1" {{ isset($getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform']) && $getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform'] == '1' ? 'checked' : '' }} required>
                                                <label for="working-yes">Yes</label>
                                            </div>
                                            <div class="radio-option">
                                                <input type="radio" id="working-no" name="isWorkingOnAnotherPlatform" value="0" {{ isset($getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform']) && $getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform'] == '0' ? 'checked' : '' }} required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" id="awhyOnBoard" name="whyOnBoard" class="form-control-modern"
                                            value="{{ $getAstrologer['recordList'][0]['whyOnBoard']}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" id="interviewSuitableTime" name="interviewSuitableTime"
                                            ...
                                            value="{{ $getAstrologer['recordList'][0]['interviewSuitableTime']}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <select class="form-control-modern" name="degree" id="degree" required>
                                            @foreach ($qualifications as $qua)
                                                <option value='{{ $qua->degreeName }}' {{ $getAstrologer['recordList'][0]['degree'] == $qua->degreeName ? 'selected' : '' }}>
                                                    {{ $qua->degreeName }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <div class="radio-group">
                                            <div class="radio-option">
                                                <input type="radio" id="refer-yes" name="isAnyBodyRefer" value="1" {{ isset($getAstrologer['recordList'][0]['isAnyBodyRefer']) && $getAstrologer['recordList'][0]['isAnyBodyRefer'] == '1' ? 'checked' : '' }} required>
                                                <label for="refer-yes">Yes</label>
                                            </div>
                                            <div class="radio-option">
                                                <input type="radio" id="refer-no" name="isAnyBodyRefer" value="0" {{ isset($getAstrologer['recordList'][0]['isAnyBodyRefer']) && $getAstrologer['recordList'][0]['isAnyBodyRefer'] == '0' ? 'checked' : '' }} required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="loginBio" name="loginBio"
                                            class="form-control-modern" required>{{ $getAstrologer['recordList'][0]['loginBio'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="goodQuality" name="goodQuality"
                                            class="form-control-modern" required>{{ $getAstrologer['recordList'][0]['goodQuality'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="biggestChallenge" name="biggestChallenge"
                                            class="form-control-modern" required>{{ $getAstrologer['recordList'][0]['biggestChallenge'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="whatwillDo" name="whatwillDo"
                                            class="form-control-modern" required>{{ $getAstrologer['recordList'][0]['whatwillDo'] }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center mt-4">
                ...
                <div class="col-lg-4 col-12 order-lg-2">
                    <div class="info-sidebar">
                        <h2>Become "{{strtoupper($appname['value'])}} Verified" Astrologer</h2>
                        <p>
