        ...
        <div class="breadcrumb-section d-none d-md-block">
            <div class="container">
                <div class="breadcrumbs">
                    ...
                    <a href="{{ route('front.getAstrologerChat') }}">My Chats</a>
                </div>
            </div>
        </div>
            ...
            <div class="chats-card">
                ...
                <div class="table-container">
                    <table class="table-modern">
                        ...
                        <tbody>
                            @forelse ($getAstrologerChat['recordList'][0]['chatHistory'] as $chatdata)
                                @if (!empty($chatdata))
                                    <tr>
                                        <td>
                                            <div class="chat-details">
                                                <h5 class="chat-title">
                                                    ...
                                                    Chat with {{ $chatdata['name'] }} for {{ $chatdata['totalMin'] }} minutes
                                                </h5>
                                                <div class="chat-date">
                                        ...
                                        <td class="chat-rate">
                                            {{ $currency['value'] }}{{ number_format($chatdata['deduction'], 2) }}
                                        </td>
                                    </tr>
                                @endif
                            @empty
