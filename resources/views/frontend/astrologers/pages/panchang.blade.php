        ...
        <div class="container">
            <div class="date-selector-section">
                <div class="date-buttons">
                    ...
                    @endphp
                    <a href="{{ route('front.getPanchang')}}" class="btn-date {{ $todayActive ? 'active' : '' }}">
                        Today
                    </a>
                    <a href="{{ route('front.getPanchang', ['panchangDate' => date('Y-m-d', strtotime('+1 day'))]) }}" class="btn-date {{ $tomorrowActive ? 'active' : '' }}">
                        Tomorrow
                    </a>
                ...
                <div class="collapse" id="calendarCollapse">
                    <div class="calendar-grid">
                        <div class="month-selector">
                            <a href="{{ route('front.getPanchang')}}" class="month-box">{{date('M Y')}}</a>
                        </div>
                        <div class="days-container">
                            ...
                            @for ($day = 1; $day <= $daysInMonth; $day++)
                                ...
                                @endphp
                                <a href="{{ route('front.getPanchang', ['panchangDate' => $fullDate]) }}" class="day-box {{ $isActive ? 'active' : '' }}">
                                    {{ $day }}
                                </a>
                            @endfor
                        </div>
                    ...
                    <div class="panchang-card">
                        ...
                        <div class="panchang-card-body">
                            <div class="panchang-detail-item">
                                ...
                                <span class="panchang-detail-value">{{$getPanchang['response']['tithi']['name'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Nakshatra</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['nakshatra']['name'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Yoga</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['yoga']['name'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Karana</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['karana']['name'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Rasi</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['rasi']['name'] ?? 'N/A'}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panchang-card">
                        ...
                        <div class="panchang-card-body">
                            <div class="panchang-detail-item">
                                ...
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['sun_rise'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Sunset</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['sun_set'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Moonrise</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['moon_rise'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Moonset</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['moon_set'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Next Full Moon</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['next_full_moon'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Next New Moon</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['next_new_moon'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Amanta Month</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['masa']['amanta_name'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Paksha</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['masa']['paksha'] ?? 'N/A'}}</span>
                            </div>
                            <div class="panchang-detail-item">
                                <span class="panchang-detail-label">Purnimanta</span>
                                <span class="panchang-detail-value">{{$getPanchang['response']['advanced_details']['masa']['purnimanta_name'] ?? 'N/A'}}</span>
                            </div>
                        </div>
                    </div>
                </div>
