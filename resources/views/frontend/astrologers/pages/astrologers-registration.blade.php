            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" id="name" value="{{ old('name') }}" name="name" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="email">Email Address<span class="required">*</span></label>
                                        <input type="email" id="email" value="{{ old('email') }}" name="email" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-group-modern">
                                            <input type="text" id="countryCode" value="{{ old('countryCode') }}" placeholder="+91" name="countryCode" class="form-control-modern">
                                            <input type="text" value="{{ old('contactNo') }}" id="contactNo" name="contactNo" class="form-control-modern" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="date" value="{{ old('birthDate') }}" name="birthDate" id="birthDate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="number" value="{{ old('charge') }}" id="charge" name="charge" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="videoCallRate">Add your video charge (as per min)<span class="required">*</span></label>
                                        <input type="number" value="{{ old('videoCallRate') }}" id="videoCallRate" name="videoCallRate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="reportRate">Add your report charge<span class="required">*</span></label>
                                        <input type="number" value="{{ old('reportRate') }}" id="reportRate" name="reportRate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="experienceInYears">Experience in years<span class="required">*</span></label>
                                        <input type="number" value="{{ old('experienceInYears') }}" id="experienceInYears" name="experienceInYears" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="dailyContribution">How many hours you can contribute daily?<span class="required">*</span></label>
                                        <input type="number" value="{{ old('dailyContribution') }}" id="dailyContribution" name="dailyContribution" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="hearAboutAstroguru">Where did you hear about {{$appname['value']}}?<span class="required">*</span></label>
                                        <input type="text" value="{{ old('hearAboutAstroguru') }}" id="hearAboutAstroguru" name="hearAboutAstroguru" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" value="{{ old('interviewSuitableTime') }}" id="interviewSuitableTime" name="interviewSuitableTime" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="currentCity">Which city do you currently live in?<span class="required">*</span></label>
                                        <input type="text" value="{{ old('currentCity') }}" id="currentCity" name="currentCity" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" value="{{ old('college') }}" id="college" name="college" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="learnAstrology">From where did you learn Astrology?<span class="required">*</span></label>
                                        <input type="text" value="{{ old('learnAstrology') }}" id="learnAstrology" name="learnAstrology" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="instaProfileLink">Instagram profile link<span class="required">*</span></label>
                                        <input type="text" value="{{ old('instaProfileLink') }}" id="instaProfileLink" name="instaProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="facebookProfileLink">Facebook profile link<span class="required">*</span></label>
                                        <input type="text" value="{{ old('facebookProfileLink') }}" id="facebookProfileLink" name="facebookProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="linkedInProfileLink">LinkedIn profile link<span class="required">*</span></label>
                                        <input type="text" value="{{ old('linkedInProfileLink') }}" id="linkedInProfileLink" name="linkedInProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="youtubeChannelLink">Youtube profile link<span class="required">*</span></label>
                                        <input type="text" value="{{ old('youtubeChannelLink') }}" id="youtubeChannelLink" name="youtubeChannelLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="websiteProfileLink">Website profile link<span class="required">*</span></label>
                                        <input type="text" value="{{ old('websiteProfileLink') }}" id="websiteProfileLink" name="websiteProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" value="{{ old('minimumEarning') }}" id="minimumEarning" name="minimumEarning" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="maximumEarning">Maximum Earning Expectation<span class="required">*</span></label>
                                        <input type="text" value="{{ old('maximumEarning') }}" id="maximumEarning" name="maximumEarning" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="loginBio" name="loginBio" class="form-control-modern" required>{{ old('loginBio') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="goodQuality">What are some good qualities of perfect astrologer?<span class="required">*</span></label>
                                        <textarea id="goodQuality" name="goodQuality" class="form-control-modern" required>{{ old('goodQuality') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="biggestChallenge" name="biggestChallenge" class="form-control-modern" required>{{ old('biggestChallenge') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="whatwillDo">A customer is asking the same question repeatedly: what will you do?<span class="required">*</span></label>
                                        <textarea id="whatwillDo" name="whatwillDo" class="form-control-modern" required>{{ old('whatwillDo') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center mt-4">
                                ...
                                @foreach ($daysOfWeek as $index => $day)
                                    <div class="col-12">
                                        <div class="availability-day">
                                            <label>{{ $day }}</label>
                                            <input type="hidden" name="astrologerAvailability[{{ $index }}][day]" value="{{ $day }}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group-modern">
                ...
                <div class="col-lg-4 col-12 order-lg-2">
                    <div class="info-sidebar">
                        <h2>Become "{{strtoupper($appname['value'])}} Verified" Astrologer: <span style="color: #ee4e5e;">Join Now!</span></h2>
                        <p>
                            {{$appname['value']}}, one of the best online astrology portals gives you a chance to be a part of its community of best and top-notch Astrologers. Become a part of the team of Astrologers and offer your consultations to clients from all across the globe, &amp; create an online, personalized brand presence.
                        </p>
                        <div class="row">
                            <div class="col-sm-6 col-12 mb-3">
                                <div class="info-card">
                                    ...
                                    @endphp
                                    @if($hasVerifiedIcon)
                                        <img src="{{ $verifiedIcon }}" alt="Verified" class="mb-2"
                                            onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            ...
                            <div class="col-sm-6 col-12 mb-3">
                                <div class="info-card">
                                    ...
                                    @endphp
                                    @if($hasAvailabilityIcon)
                                        <img src="{{ $availabilityIcon }}" alt="24/7" class="mb-2"
                                            onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <div class="image-placeholder" style="display: none; width: 60px; height: 60px; font-size: 24px; margin: 0 auto 10px;">
