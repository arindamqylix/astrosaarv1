                ...
                <div class="col-lg-8">
                    <div class="recharge-cards-grid" id="plan-item">
                        @foreach ($getRechargeAmount['recordList'] as $index => $amount)
                            <div class="recharge-card {{ $index == 0 ? 'selected' : '' }}" data-amount="{{ $amount['amount'] }}" data-cashback="{{ $amount['cashback'] }}">
                                <div class="cashback-badge">{{ $amount['cashback'] }}% Extra</div>
                                <div class="recharge-amount">{{ $currency['value'] }}{{ number_format($amount['amount'], 2) }}</div>
                    ...
                    <div class="order-summary-card">
                        ...
                        <form id="prcdtopayform">
                            <div class="order-summary-item">
                                ...
                                <span class="value" id="total_plan_amount">{{ $currency['value'] }}{{ number_format($selectedamount['amount'], 2) }}</span>
                            </div>
                            ...
                            <div class="order-summary-item" id="gst_details">
                                ...
                                <span class="value" id="total_plan_gst_amount">{{ $currency['value'] }}{{ number_format($selectedamount['amount'] * ($gstvalue['value'] / 100), 2) }}</span>
                            </div>

                            <div class="order-summary-item total">
                                <span class="label">Total</span>
                                <span class="value total_plan_amount_with_gst">{{ $currency['value'] }}{{ number_format($selectedamount['amount'] + $selectedamount['amount'] * ($gstvalue['value'] / 100), 2) }}</span>
                            </div>
                            ...
                            <div class="cashback-section" id="total-cashback-amount">
                                ...
                                @endphp
                                @if($hasCashbackIcon)
                                    <img src="{{ $cashbackIcon }}" alt="Cashback" class="cashback-icon"
                                ...
                                <div class="cashback-info">
                                    <h4>
                                        <span id="total_plan_cashback_percent">{{ $selectedamount['cashback'] }}% Extra</span>
                                    </h4>
                                    <p>
                                        <span id="total_plan_cashback_amount">{{ $currency['value'] }}{{ number_format(($selectedamount['amount'] * $selectedamount['cashback']) / 100, 2) }} cashback</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <button type="button" class="btn-proceed" id="proceedbtn">
                                <i class="fas fa-lock mr-2"></i> Proceed To Pay {{ $currency['value'] }}{{ number_format($selectedamount['amount'] + $selectedamount['amount'] * ($gstvalue['value'] / 100), 2) }}
                            </button>
