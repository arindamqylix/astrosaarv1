                    ...
                    <div class="d-block d-md-flex align-items-start">
                        ...
                        <div class="ml-md-4 mt-3 mt-md-0" style="flex: 1;">
                            ...
                            <div class="text-center text-md-left mb-3">
                                <div class="mb-2">
                                    @foreach ($getAstrologer['recordList'][0]['primarySkill'] as $index => $primarySkill)
                                        <span class="badge badge-pill mr-2 mb-2" 
                                            ...
                                            <i class="fas fa-star mr-1"></i>{{ $primarySkill['name'] }}
                                        </span>
                                    @endforeach
                            </div>
                                <p class="font-16 m-0 profileCatName color-darkgray">
                                    <i class="fas fa-language mr-1" style="color: #6d4ec6;"></i>
                                    @foreach ($getAstrologer['recordList'][0]['languageKnown'] as $index => $language)
                                        <span class="colorblack lang">{{ $language['languageName'] }}@if($index < count($getAstrologer['recordList'][0]['languageKnown']) - 1),@endif</span>
                                    @endforeach
                                </p>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center justify-content-md-start flex-wrap" 
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="font-16 font-weight-bold colorblack ml-1">{{ $getAstrologer['recordList'][0]['ratingcount'] }}</span>
                            </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="colorblack ml-1 font-weight-bold">{{ $getAstrologer['recordList'][0]['experienceInYears'] }} Years</span>
                        </div>
                    </div>
                </div>
                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right">
                                            <div class="font-12" style="color: #ef4444; font-weight: 600;">
                                                {{$getAstrologer['recordList'][0]['chatStatus'] ?? 'Offline'}}
                                            </div>
                                            <div class="font-14">{{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['charge'] }}/Min</div>
                                        </div>
                                    </div>
                                    </a>
                                </div>
                                        ...
                                        <div class="text-right">
                                            @if ($getAstrologer['recordList'][0]['isFreeAvailable'] == true)
                                                <div class="font-12" style="text-decoration: line-through; opacity: 0.7;">
                                                    {{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['charge'] }}/Min
                                                </div>
                                                <div class="font-16 font-weight-bold">FREE</div>
                                            @else
                                                <div class="font-16 font-weight-bold">{{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['charge'] }}/Min</div>
                                            @endif
                                        </div>
                                    </div>
                                    </a>
                                ...
                                <a class="btn btn-block btn-chat-profile expert-busy btn-opacity disabled shadow-sm" 
                                   style="background: #f3f4f6; border: 2px solid #d1d5db; color: #9ca3af; cursor: not-allowed;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right">
                                            <div class="font-12" style="color: #ef4444; font-weight: 600;">
                                                {{$getAstrologer['recordList'][0]['callStatus'] ?? 'Offline'}}
                                            </div>
                                            <div class="font-14">{{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['charge'] }}/Min</div>
                                        </div>
                                    </div>
                                   ...
                                   style="background: #f3f4f6; border: 2px solid #d1d5db; color: #9ca3af; cursor: not-allowed;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <div class="font-14">{{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['videoCallRate'] }}/Min</div>
                                        </div>
                                    </div>
                                    </a>
                                </div>
                                   ...
                                   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(245,158,11,0.3)';">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right">
                                            @if ($getAstrologer['recordList'][0]['isFreeAvailable'] == true)
                                                <div class="font-12" style="text-decoration: line-through; opacity: 0.7;">
                                                    {{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['videoCallRate'] }}/Min
                                                </div>
                                                <div class="font-16 font-weight-bold">FREE</div>
                                            @else
                                                <div class="font-16 font-weight-bold">{{ $currency['value'] }} {{ $getAstrologer['recordList'][0]['videoCallRate'] }}/Min</div>
                                            @endif
                                        </div>
                                    </div>
                                    </a>
                ...
                <div class="bg-white div_Shadow pb-4" style="border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); padding: 30px;">
                        ...
                        <div id="profile-specialization">
                            ...
                            @foreach ($getAstrologer['recordList'][0]['astrologerCategoryId'] as $category)
                                    <span class="badge badge-pill mr-2 mb-2" 
                                        ...
                                        <i class="fas fa-check-circle mr-1"></i>{{ $category['name'] }}
                                    </span>
                            @endforeach
                    </div>
                        </div>
                    ...
                    <div class="mb-4" style="border-top: 2px solid #f3f4f6; padding-top: 25px;">
                        ...
                        <p class="font15 colorblack m-0 p-0 pt-2" style="line-height: 1.8; color: #4b5563; font-size: 15px;">
                            ...
                            <strong style="color: #6d4ec6;">{{ $getAstrologer['recordList'][0]['experienceInYears'] }} years</strong> now. 
                            I obtained my <strong>{{ $getAstrologer['recordList'][0]['degree'] }}</strong> degree from 
                            <strong>{{ $getAstrologer['recordList'][0]['college'] }}</strong> college.
                        </p>
                    </div>
                                    ...
                                    <div class="schedule-range pb-3">
                                            <div class="d-block text-center">
                                                ...
                                                <p class="color-red font-12 font-weight-semi-bold mb-3" style="color: #6d4ec6; font-size: 12px;">
                                                    {{ \Carbon\Carbon::parse($astrologerAvailability['day'])->format('M d') }}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="bg-white div_Shadow" id="review" 
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4" 
                        ...
                        <h3 class="font-20 colorblack pb-0 font-weight-bold mb-0" style="color: #6d4ec6; font-size: 24px;">
                            ...
                            <span class="color-red" style="color: #f59e0b;">{{ $getAstrologer['recordList'][0]['ratingcount'] }}</span>
                        </h3>
                    ...
                    <div class="reviewrapper list row">
                        @foreach ($getAstrologer['recordList'][0]['review'] as $index => $review)
                                <div class="reviewslist col-sm-12 col-md-6 mb-4 {{ $index % 2 == 0 ? 'even' : 'odd' }}">
