                ...
                <form id="frmUpdateProfile" enctype="multipart/form-data">
                    ...
                    <div class="profile-picture-section">
                        <div class="profile-picture-wrapper">
                            <img id="profilePreview" src="{{ isset($getuserdetails['userDetails']['profilepic']) && $getuserdetails['userDetails']['profilepic'] ? asset('public/storage/' . $getuserdetails['userDetails']['profilepic']) : asset('public/frontend/images/default-avatar.png') }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-icon">
                                        ...
                                        <input autocomplete="off" class="form-control" id="EmailAddress"
                                               ...
                                               type="email" value="{{$getuserdetails['userDetails']['email']}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-icon">
                                        ...
                                        <input autocomplete="off" class="form-control" id="ContactMobile"
                                               ...
                                               type="tel" value="{{$getuserdetails['userDetails']['contactNo']}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-icon">
                                        ...
                                        <select class="form-control" id="Gender" name="gender">
                                            <option value="" {{ $getuserdetails['userDetails']['gender'] == 0 ? 'selected' : '' }}>--Select Gender--</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-icon">
                                        ...
                                        <input type="date" name="birthDate" class="form-control" 
                                               value="{{date("Y-m-d", strtotime($getuserdetails['userDetails']['birthDate']));}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-icon">
                                        ...
                                        <input autocomplete="off" class="form-control" id="PinCode"
                                               ...
                                               type="text" value="{{$getuserdetails['userDetails']['pincode']}}">
                                    </div>
