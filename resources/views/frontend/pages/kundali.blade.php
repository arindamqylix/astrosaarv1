                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <select name="kundali[0][pdf_type]" onchange="updateAmount()"
                                                    ...
                                                    <option value="small" data-price="{{ $getkundaliprice['recordList']['SMALL'] }}">
                                                        Small ({{$currency['value']}}{{ $getkundaliprice['recordList']['SMALL'] }})
                                                    </option>
                                                    <option value="medium" data-price="{{ $getkundaliprice['recordList']['MEDIUM'] }}">
                                                        Medium ({{$currency['value']}}{{ $getkundaliprice['recordList']['MEDIUM'] }})
                                                    </option>
                                                    <option value="large" data-price="{{ $getkundaliprice['recordList']['LARGE'] }}">
                                                        Large ({{$currency['value']}}{{ $getkundaliprice['recordList']['LARGE'] }})
                                                    </option>
                                                </select>
                ...
                <div class="col-lg-4 col-12">
                    <div class="saved-reports-card">
                        ...
                        <div class="saved-reports-body" id="savedKundalies">
                            @if(count($getkundali['recordList']) > 0)
                                        ...
                                        <a href="{{ url('public/' . $getkundali['pdf_link']) }}" 
                                           style="text-decoration: none; color: inherit; display: flex; align-items: center;">
                                            ...
                                            <div class="kundali-info">
                                                <h6>{{ $getkundali['name'] }}</h6>
                                                <p><i class="far fa-calendar mr-1"></i> {{ $getkundali['created_at'] }}</p>
                                                <p><i class="fas fa-map-marker-alt mr-1"></i> {{ $getkundali['birthPlace'] }}</p>
                                            </div>
                                        </a>
                                    </div>
                                @endforeach
            ...
            <div class="info-section" style="background: linear-gradient(135deg, #6d4ec6 0%, #8b6fd8 100%); color: #fff;">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center d-none d-md-block">
                        <img src="{{ asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/kundali-dosha-banner.png') }}" 
