...
<div class="astroway-footer">
                ...
                <div class="col-sm-12 col-md-7 col-lg-9">
                    <div class="row">
                            ...
                            <div class="d-flex justify-content-between">
                                <ul class="list-unstyled">
                                  ...
                                  ?>
                                   ...
                                   <li>
                                       <a href="<?php echo e(route('front.chatList', ['astrologerCategoryId' => $category->id])); ?>" 
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.getproducts')); ?>"
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.getBlog')); ?>"
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <p class="mb-2">
                                <a href="<?php echo e(route('front.privacyPolicy')); ?>" class="font-14 text-white">Privacy policy</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-brown-dark copyright" style="background-color: #5a3aa0 !important;">
        <div class="container py-3">
            <p class="text-center text-white mb-1">Copyright &copy; 2020-<?php echo e(date('Y')); ?> <?php echo e($appName->value ?? 'AstroSaar'); ?>. All
                Rights Reserved</p>
...
<?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>