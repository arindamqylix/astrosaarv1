            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('front.getproducts')); ?>">Products</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="product-image-section">
                            ...
                            ?>
                            <?php if($hasImage): ?>
                                <img src="/<?php echo e($product['productImage']); ?>" alt="<?php echo e($product['name']); ?>" loading="lazy"
                    ...
                    <div class="col-md-7">
                        <div class="product-info-section">
                            <div class="product-category">
                                <i class="fas fa-tag mr-2"></i> <?php echo e($product['productCategory']); ?>
                            ...
                            <div class="product-price-section">
                                ...
                                <div class="product-price">
                                    <span class="product-price-currency"><?php echo e($currency['value']); ?></span><?php echo e(number_format($product['amount'], 2)); ?>
                            ...
                            <div class="product-details-card">
                                ...
                                <p class="product-description"><?php echo e($product['features'] ?? 'No description available.'); ?></p>
                            </div>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('front.checkout', ['id' => $product['id']])); ?>" class="btn-buy-now">
                                    <i class="fas fa-shopping-cart"></i> Buy Now
                                </a>
                            <?php endif; ?>
                        </div>
                ...
                <div class="recent-products-grid">
                    <?php $__currentLoopData = $getAstromallProduct['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="recent-product-card">
                            <a href="<?php echo e(route('front.getproductDetails',['id'=>$shop['id']])); ?>" class="recent-product-image">
                                <?php
                            ...
                            <div class="recent-product-body">
                                <h3 class="recent-product-name"><?php echo e($shop['name']); ?></h3>
                                <div class="recent-product-price">
                                    <span class="recent-product-price-currency"><?php echo e($currency['value']); ?></span><?php echo e(number_format($shop['amount'], 2)); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/product-details.blade.php ENDPATH**/ ?>