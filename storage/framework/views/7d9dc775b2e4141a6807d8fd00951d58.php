                    ...
                    <div class="mt-4">
                        ...
                        <div class="table-container">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if(isset($getUserById['recordList'][0]['chatRequest']['chatHistory']) && count($getUserById['recordList'][0]['chatRequest']['chatHistory']) > 0): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="chat-details">
                                                            <h5 class="chat-title">
                                                                Chat with <?php echo e($chatdata['astrologerName'] ?? 'Astrologer'); ?> for <?php echo e($chatdata['totalMin'] ?? 0); ?> minutes
                                                            </h5>
                                                            <div class="chat-date">
                                                                <?php echo e(isset($chatdata['created_at']) ? date('j F Y, h:i A', strtotime($chatdata['created_at'])) : 'N/A'); ?>
                                                    ...
                                                    <td class="deduction-amount">
                                                        -<?php echo e($currency['value']); ?><?php echo e(number_format($chatdata['deduction'] ?? 0, 2)); ?>

                                                    </td>
                                                    <td style="text-align: right;">
                                                        <a href="<?php echo e(route('front.getChatHistory', ['astrologerId' => $chatdata['astrologerId'] ?? ''])); ?>" class="btn-view">View</a>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/my-chats.blade.php ENDPATH**/ ?>