    ...
    <script>
        ...
        function handleBroadcastEnd() {
             $.ajax({
                ...
                type: 'POST',
                data: {
                    astrologerId: "<?php echo e($liveAstrologer->astrologerId); ?>",
                },
                success: function(response) {
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/live-astrologer-details.blade.php ENDPATH**/ ?>