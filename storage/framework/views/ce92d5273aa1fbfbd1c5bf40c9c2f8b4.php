                                ...
                                <div class="control-top-left">
                                    <div class="expert-info">
                                        ...
                                        <?php if($hasProfileImage): ?>
                                            <img id="expertImgLive" src="/<?php echo e($liveAstrologer->profileImage); ?>" 
                                                class="expert-avatar" alt="<?php echo e($expertName); ?>"
                                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="image-placeholder" style="display: none;">
                                                <?php echo e($expertInitial); ?>
                                        ...
                                        <div class="expert-details">
                                            <div class="expert-name" id="expertNameLive"><?php echo e($expertName); ?></div>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center" style="padding: 30px 20px;">
                        <div class="mb-4">
                            ...
                            ?>
                            <?php if($hasProfileImage): ?>
                                <img id="leave-expert-image" src="/<?php echo e($liveAstrologer->profileImage); ?>" 
                                    class="rounded-circle" width="90" height="90" alt="<?php echo e($expertName); ?>"
                                    onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                        ...
                        <h3 class="font-weight-bold" id="leave-expert-name" style="color: #333; margin-bottom: 20px;"><?php echo e($expertName); ?></h3>
                        ...
                        <div class="modal-body">
                            <div class="wallet-balance-box">
                                ...
                                <div class="balance-amount">
                                    <?php echo e($currency['value']); ?><span id="gift-wallet-balance"><?php echo e(number_format($wallet_amount, 2)); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="gift-grid" id="loadGiftItems">
                                <?php $__currentLoopData = $getGift['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gift-item" data-gift-id="<?php echo e($gift['id']); ?>" data-gift-amount="<?php echo e($gift['amount']); ?>">
                                        <?php
                                            $hasGiftImage = !empty($gift['image']);
                                        ?>
                                        <?php if($hasGiftImage): ?>
                                            <img src="/<?php echo e($gift['image']); ?>" alt="<?php echo e($gift['name']); ?>"
                                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        ...
                                        <?php endif; ?>
                                        <p class="gift-name"><?php echo e($gift['name']); ?></p>
                                        <p class="gift-price"><?php echo e($currency['value']); ?><?php echo e(number_format($gift['amount'], 2)); ?></p>
                                    </div>
                        ...
                        <div class="modal-footer" style="border-top: 2px solid #f0f0f0; padding: 20px;">
                            <div class="w-100 d-flex justify-content-center gap-3">
                                <?php if($wallet_amount > 0): ?>
                                    <a class="btn-waitlist" href="<?php echo e(route('front.walletRecharge')); ?>" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('front.walletRecharge')); ?>" class="btn-waitlist" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                                        <i class="fas fa-wallet mr-2"></i> Recharge
                                    </a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            <?php if(astroauthcheck()): ?>
                var accountName = "liveAstrologer_<?php echo e(astroauthcheck()['id']); ?>";
            <?php endif; ?>
            ...
            rTmclient.login({
                ...
                channel.join().then(() => {
                    ...
                    function sendMSG(singleMessage) {
                        ...
                        var imageUrl = '';
                        <?php if(astroauthcheck()): ?>
                            var accountName = "<?php echo e(astroauthcheck()['name']); ?>";
                            <?php if(astroauthcheck()['profile']): ?>
                            var imageUrl = "<?php echo e(url('/')); ?>" +
                                "/<?php echo e(astroauthcheck()['profile']); ?>";
                            <?php else: ?>{
                                var imageUrl = "<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>";
                            }
                            <?php endif; ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            function endLiveSession() {
                ...
                endingSession = true;
                $.ajax({
                    url: '<?php echo e(route("api.endLiveSession")); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('frontend.astrologers.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/astrologers/pages/live-astrologer.blade.php ENDPATH**/ ?>