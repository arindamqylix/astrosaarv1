        ...
        <div class="container">
            ...
            <div class="date-selector-section">
                <div class="date-buttons">
                    ...
                    ?>
                    <a class="btn-date <?php echo e($todayActive ? 'active' : ''); ?>" href="<?php echo e(route('front.getPanchang')); ?>">
                        <i class="fas fa-calendar-day mr-2"></i> Today
                    </a>
                    <a class="btn-date <?php echo e($tomorrowActive ? 'active' : ''); ?>" href="<?php echo e(route('front.getPanchang', ['panchangDate' => date('Y-m-d', strtotime('+1 day'))])); ?>">
                    ...
                    <div class="calendar-container">
                        ...
                        <div class="calendar-days">
                            ...
                            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                                ...
                                ?>
                                <a href="<?php echo e(route('front.getPanchang', ['panchangDate' => $fullDate])); ?>" 
                                   class="calendar-day <?php echo e($isActive ? 'active' : ''); ?>">
                                    <?php echo e($day); ?>
                    ...
                    <div class="panchang-card-body">
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['tithi']['name'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['nakshatra']['name'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['yoga']['name'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['karana']['name'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['rasi']['name'] ?? 'N/A'); ?>
                ...
                <div class="panchang-card">
                    ...
                    <div class="panchang-card-body">
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['sun_rise'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['sun_set'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['moon_rise'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['moon_set'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['next_full_moon'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['next_new_moon'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['masa']['amanta_name'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['masa']['paksha'] ?? 'N/A'); ?>
                        ...
                        <div class="panchang-item">
                            ...
                            <div class="panchang-item-value">
                                <?php echo e($getPanchang['response']['advanced_details']['masa']['purnimanta_name'] ?? 'N/A'); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/panchang.blade.php ENDPATH**/ ?>