    ...
    <div class="status-section">
        ...
        <div class="status-dropdown">
            <select id="chat-status" class="status-select">
                <option value="Online" <?php echo e($getAstrologer->chatStatus == 'Online' ? 'selected' : ''); ?>>Online</option>
                <option value="Offline" <?php echo e($getAstrologer->chatStatus == 'Offline' || empty($getAstrologer->chatStatus) ? 'selected' : ''); ?>>Offline</option>
            </select>
        </div>
    </div>
    <div class="status-section">
        ...
        <div class="status-dropdown">
            <select id="call-status" class="status-select">
                <option value="Online" <?php echo e($getAstrologer->callStatus == 'Online' ? 'selected' : ''); ?>>Online</option>
                <option value="Offline" <?php echo e($getAstrologer->callStatus == 'Offline' || empty($getAstrologer->callStatus) ? 'selected' : ''); ?>>Offline</option>
            </select>
        </div>
    </div>
    <div class="status-section">
        ...
        <audio id="sound-player" src="<?php echo e(asset('public/sound/ringtone-126505.mp3')); ?>"></audio>
    </div>
</div>
                            ...
                            <form action="" id="chatForm">
                                <div class="request-item">
                                    ...
                                    <div class="request-user-info">
                                        ...
                                        ?>
                                        <?php if($hasImage): ?>
                                            <img src="/<?php echo e($request['profile']); ?>" class="request-avatar" alt="<?php echo e($userName); ?>"
                                        ...
                                        <div class="request-details">
                                            <div class="request-name"><?php echo e($userName); ?></div>
                                            <div class="request-meta">
                                                <div>
                                                    <i class="fa fa-calendar"></i>
                                                    <span><?php echo e(date('d-m-Y', strtotime($request['chatcreatedat']))); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="request-user-info">
                                        ...
                                        <div class="request-details">
                                            ...
                                            <div class="request-meta">
                                                <div>
                                                    <i class="fa fa-calendar"></i>
                                                    <span><?php echo e(date('d-m-Y', strtotime($request['callcreatedat']))); ?></span>
                                                </div>
                                                <div>
                ...
                <div class="request-card-body" id="reportRequests">
                    <?php if(isset($getUserReport['recordList']) && count($getUserReport['recordList']) > 0): ?>
                        <?php $__currentLoopData = $getUserReport['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getUserReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="report-type-badge"><?php echo e($getUserReport['reportType']); ?></div>
                            <div class="request-item reportList" data-toggle="modal" data-target="#reportModal" data-id="<?php echo e($getUserReport['id']); ?>" style="cursor: pointer;">
                                <div class="request-user-info">
                                    <?php
                                    ...
                                    ?>
                                    <?php if($hasImage): ?>
                                        <img src="/<?php echo e($getUserReport['profile']); ?>" class="request-avatar" alt="<?php echo e($userName); ?>"
                                             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <div class="image-placeholder image-placeholder-circle image-placeholder-profile" style="display: none;">
                                            <?php echo e($firstLetter); ?>
                                    ...
                                    <div class="request-details">
                                        ...
                                        <div class="request-meta">
                                            <div>
                                                <i class="fa fa-calendar"></i>
                                                <span><?php echo e(date('d-m-Y', strtotime($getUserReport['birthDate']))); ?></span>
                                            </div>
                                            <div>
                                                <i class="fa fa-clock"></i>
                                                <span><?php echo e($getUserReport['birthTime']); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $('#chat-status').on('change', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('api.addChatStatus')); ?>",
            type: 'POST',
            data: {
                status: chatStatus,
                token:"<?php echo e($token); ?>",
                astrologerId:"<?php echo e($astrologerId); ?>"
            },
            success: function(response) {
...
$('#call-status').on('change', function() {
    ...
    $.ajax({
        url: "<?php echo e(route('api.addCallStatus')); ?>",
        type: 'POST',
        data: {
            status: callStatus,
            token:"<?php echo e($token); ?>",
...
<?php echo $__env->make('frontend.astrologers.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/astrologers/pages/index.blade.php ENDPATH**/ ?>