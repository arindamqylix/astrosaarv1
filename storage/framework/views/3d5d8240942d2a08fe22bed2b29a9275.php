                    ...
                    <div class="mt-4">
                        ...
                        <div class="table-container">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if(isset($getUserById['recordList'][0]['callRequest']['callHistory']) && count($getUserById['recordList'][0]['callRequest']['callHistory']) > 0): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="call-details">
                                                            <h5 class="call-title">
                                                                <span class="call-type-badge"><?php echo e(isset($calldata['call_type']) && $calldata['call_type'] == 10 ? 'Audio' : 'Video'); ?></span>
                                                                Call with <?php echo e($calldata['astrologerName'] ?? 'Astrologer'); ?> for <?php echo e($calldata['totalMin'] ?? 0); ?> minutes
                                                            </h5>
                                                            <div class="call-date">
                                                                <?php echo e(isset($calldata['created_at']) ? date('j F Y, h:i A', strtotime($calldata['created_at'])) : 'N/A'); ?>
                                                    ...
                                                    <td class="deduction-amount">
                                                        -<?php echo e($currency['value']); ?><?php echo e(number_format($calldata['deduction'] ?? 0, 2)); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/my-calls.blade.php ENDPATH**/ ?>