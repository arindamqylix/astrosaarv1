        ...
        <div class="container">
            <div class="d-flex align-items-center w-100 justify-content-between">
                ...
                <ul class="header-nav-center d-none d-lg-flex">
                    <li><a href="<?php echo e(route('front.getkundali')); ?>">Free Kundli</a></li>
                    <li><a href="<?php echo e(route('front.kundaliMatch')); ?>">Kundli Matching</a></li>
                ...
                <div class="d-flex align-items-center header-buttons">
                    <div class="d-none d-lg-flex align-items-center mr-2" style="gap: 8px;">
                        <a href="<?php echo e(route('front.talkList')); ?>" id="callPg" class="btn-talk-astrologer">
                            Talk to Astrologer
                        </a>
                        <a href="<?php echo e(route('front.chatList')); ?>" id="chatPg" class="btn-chat-astrologer">
                                    ...
                                    <div class="dropdown-menu user-options fadeInUp5px dropdown-menu-right dropdown-menu-lg-left"
                                        ...
                                        <ul>
                                            <li class="namedisplay d-block text-center">
                                                ...
                                                <div>
                                                    <h2 class="pt-3"><?php echo e(str_repeat('X', 6) . substr(authcheck()['contactNo'], -4)); ?></h2>
                                                    <h3></h3>
                                                </div>
                                            </li>
                                            <li class="d-lg-block">
                            ...
                            <div class="w-100">
                                <div class="row my-4">
                                    ...
                                    <ul class="navbar-nav pt-3 px-3 w-100 d-lg-none">
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('front.getkundali')); ?>" class="nav-link">Free Kundli</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('front.kundaliMatch')); ?>" class="nav-link">Kundli Matching</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#" class="nav-link">Compatibility</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('front.horoScope')); ?>" class="nav-link">Horoscopes</a>
                                        </li>
                                        <li class="nav-item">
...
<?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/layout/header.blade.php ENDPATH**/ ?>