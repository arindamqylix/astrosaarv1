        ...
        <div class="col-12 contactbox align-self-center text-center" style="margin-top :0!important">
            ...
            <div class="row pt-3 pt-md-5 justify-content-between inpage mt-4">
                ...
                <div class="col-12 col-md-6 pt-5 pt-md-0  text-left">
                    ...
                    <form id="contactform" method="post" action="<?php echo e(route('front.astrologers.store.contact')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.astrologers.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/astrologers/pages/contact.blade.php ENDPATH**/ ?>