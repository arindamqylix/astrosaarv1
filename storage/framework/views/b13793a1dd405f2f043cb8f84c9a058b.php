...
<?php $__env->startSection('content'); ?>
    <div class="registration-page">
        <div class="breadcrumb-section d-none d-md-block">
            <div class="container">
                <div class="breadcrumbs">
                    ...
                    <span>Astrologer Registration</span>
                </div>
            </div>
        </div>
        ...
        <div class="page-header-section">
            <div class="container">
                <h1>Become a Verified Astrologer</h1>
                <p>Join our community of expert astrologers and start your journey</p>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" id="name" value="<?php echo e(old('name')); ?>" name="name" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="email">Email Address<span class="required">*</span></label>
                                        <input type="email" id="email" value="<?php echo e(old('email')); ?>" name="email" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-group-modern">
                                            <input type="text" id="countryCode" value="<?php echo e(old('countryCode')); ?>" placeholder="+91" name="countryCode" class="form-control-modern">
                                            <input type="text" value="<?php echo e(old('contactNo')); ?>" id="contactNo" name="contactNo" class="form-control-modern" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="file" class="form-control-modern" id="profileImage" name="profileImage" accept="image/*" required>
                                        <div id="imagePreviewContainer" class="mt-3 text-center" style="display: none;">
                                            ...
                                            <div class="image-placeholder" style="display: none;">
                                                <?php echo e(strtoupper(substr(old('name', 'U'), 0, 1))); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="date" value="<?php echo e(old('birthDate')); ?>" name="birthDate" id="birthDate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="astrologerCategoryId">Category<span class="required">*</span></label>
                                        <select class="form-control-modern select2" name="astrologerCategoryId[]" id="astrologerCategoryId" multiple required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="number" value="<?php echo e(old('charge')); ?>" id="charge" name="charge" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="videoCallRate">Add your video charge (as per min)<span class="required">*</span></label>
                                        <input type="number" value="<?php echo e(old('videoCallRate')); ?>" id="videoCallRate" name="videoCallRate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="reportRate">Add your report charge<span class="required">*</span></label>
                                        <input type="number" value="<?php echo e(old('reportRate')); ?>" id="reportRate" name="reportRate" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="experienceInYears">Experience in years<span class="required">*</span></label>
                                        <input type="number" value="<?php echo e(old('experienceInYears')); ?>" id="experienceInYears" name="experienceInYears" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="dailyContribution">How many hours you can contribute daily?<span class="required">*</span></label>
                                        <input type="number" value="<?php echo e(old('dailyContribution')); ?>" id="dailyContribution" name="dailyContribution" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="hearAboutAstroguru">Where did you hear about <?php echo e($appname['value']); ?>?<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('hearAboutAstroguru')); ?>" id="hearAboutAstroguru" name="hearAboutAstroguru" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <div class="radio-group">
                                            <div class="radio-option">
                                                <input type="radio" id="working-yes" name="isWorkingOnAnotherPlatform" value="1" required>
                                                <label for="working-yes">Yes</label>
                                            </div>
                                            <div class="radio-option">
                                                <input type="radio" id="working-no" name="isWorkingOnAnotherPlatform" value="0" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" id="awhyOnBoard" name="whyOnBoard" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="interviewSuitableTime">What is suitable time for interview?<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('interviewSuitableTime')); ?>" id="interviewSuitableTime" name="interviewSuitableTime" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="currentCity">Which city do you currently live in?<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('currentCity')); ?>" id="currentCity" name="currentCity" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" value="<?php echo e(old('college')); ?>" id="college" name="college" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="learnAstrology">From where did you learn Astrology?<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('learnAstrology')); ?>" id="learnAstrology" name="learnAstrology" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="instaProfileLink">Instagram profile link<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('instaProfileLink')); ?>" id="instaProfileLink" name="instaProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="facebookProfileLink">Facebook profile link<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('facebookProfileLink')); ?>" id="facebookProfileLink" name="facebookProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="linkedInProfileLink">LinkedIn profile link<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('linkedInProfileLink')); ?>" id="linkedInProfileLink" name="linkedInProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="youtubeChannelLink">Youtube profile link<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('youtubeChannelLink')); ?>" id="youtubeChannelLink" name="youtubeChannelLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="websiteProfileLink">Website profile link<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('websiteProfileLink')); ?>" id="websiteProfileLink" name="websiteProfileLink" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <div class="radio-group">
                                            <div class="radio-option">
                                                <input type="radio" id="refer-yes" name="isAnyBodyRefer" value="1" required>
                                                <label for="refer-yes">Yes</label>
                                            </div>
                                            <div class="radio-option">
                                                <input type="radio" id="refer-no" name="isAnyBodyRefer" value="0" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" value="<?php echo e(old('minimumEarning')); ?>" id="minimumEarning" name="minimumEarning" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="maximumEarning">Maximum Earning Expectation<span class="required">*</span></label>
                                        <input type="text" value="<?php echo e(old('maximumEarning')); ?>" id="maximumEarning" name="maximumEarning" class="form-control-modern" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="NoofforeignCountriesTravel">Number of the foreign countries you lived/travel to?<span class="required">*</span></label>
                                        <select class="form-control-modern" name="NoofforeignCountriesTravel" id="NoofforeignCountriesTravel" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <select class="form-control-modern" name="currentlyworkingfulltimejob" id="currentlyworkingfulltimejob" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="loginBio" name="loginBio" class="form-control-modern" required><?php echo e(old('loginBio')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="goodQuality">What are some good qualities of perfect astrologer?<span class="required">*</span></label>
                                        <textarea id="goodQuality" name="goodQuality" class="form-control-modern" required><?php echo e(old('goodQuality')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <textarea id="biggestChallenge" name="biggestChallenge" class="form-control-modern" required><?php echo e(old('biggestChallenge')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        <label for="whatwillDo">A customer is asking the same question repeatedly: what will you do?<span class="required">*</span></label>
                                        <textarea id="whatwillDo" name="whatwillDo" class="form-control-modern" required><?php echo e(old('whatwillDo')); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center mt-4">
                            ...
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-12">
                                        <div class="availability-day">
                                            ...
                                            <input type="hidden" name="astrologerAvailability[<?php echo e($index); ?>][day]" value="<?php echo e($day); ?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group-modern">
                                ...
                                <div class="col-12">
                                    <div class="checkbox-modern">
                                        ...
                                        <label for="tandc">
                                            I Agree To <?php echo e($appname['value']); ?> 
                                            <a href="#" target="_blank" style="color:#EE4E5E !important">Terms Of Use</a> 
                                            and 
                                            <a href="#" target="_blank" style="color:#EE4E5E !important">Privacy Policy</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-12 order-lg-2">
                    <div class="info-sidebar">
                        <h2>Become "<?php echo e(strtoupper($appname['value'])); ?> Verified" Astrologer: <span style="color: #ee4e5e;">Join Now!</span></h2>
                        <p>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/astrologers/pages/astrologers-registration.blade.php ENDPATH**/ ?>