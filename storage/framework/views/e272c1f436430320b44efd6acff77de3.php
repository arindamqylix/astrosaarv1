                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap: 15px;">
                        ...
                        <div class="d-flex align-items-center flex-wrap" style="gap: 15px;">
                            ...
                            <span class="d-none d-sm-inline" style="color: #2c1f0f; font-size: 14px; font-weight: 600;">
                                Available Balance: <span style="color: #6d4ec6;"><?php echo e($currency['value']); ?><?php echo e(number_format($walletBalance ?? 0, 2)); ?></span>
                            </span>
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-wrap" style="gap: 10px;">
                            <a href="<?php echo e(route('front.walletRecharge')); ?>" 
                            ...
                            <form action="<?php echo e(route('front.talkList')); ?>" method="GET" class="d-inline-flex align-items-center" style="position: relative;">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="filter-buttons-wrapper" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; margin-bottom: 20px;">
                                        <a href="<?php echo e(route('front.talkList', ['astrologerCategoryId' => 0])); ?>" 
                                           class="filter-btn <?php echo e($astrologerCategoryId == '0' ? 'active' : ''); ?>"
                                        ...
                                        <?php $__currentLoopData = $getAstrologerCategory['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('front.talkList', ['astrologerCategoryId' => $category['id']])); ?>" 
                                               class="filter-btn <?php echo e($astrologerCategoryId == $category['id'] ? 'active' : ''); ?>"
                                               style="padding: 10px 20px; border-radius: 25px; text-decoration: none; font-size: 14px; font-weight: 600; transition: all 0.3s ease; border: 2px solid;">
                            ...
                            <div class="row d-none d-md-flex">
                                <div class="col-12 text-center">
                                    <select class="form-control sort-select" name="sortBy"
                                        ...
                                        <option value="1" <?php echo e($sortBy == '1' ? 'selected' : ''); ?>>Online First</option>
                ...
                <div id="expert-list" class="astrologer-grid-container">
                    <?php if(isset($getAstrologer['recordList']) && count($getAstrologer['recordList']) > 0): ?>
                        <?php $__currentLoopData = $getAstrologer['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrologer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="astrologer-card-grid" data-astrologer-id="<?php echo e($astrologer['id']); ?>">
                                <!-- Profile Image with Status -->
                                <div class="card-image-section">
                                    <a href="<?php echo e(route('front.astrologerDetails', ['id' => $astrologer['id']])); ?>" class="profile-image-link">
                                        <div class="profile-image-wrapper">
                                            ...
                                            <img src="<?php echo e($profileImage); ?>" 
                                                alt="<?php echo e($astrologer['name']); ?>"
                                                class="profile-image"
                                                loading="lazy"
                                                onerror="this.onerror=null; this.src='<?php echo e($defaultImage); ?>';">
                                            <?php if($astrologer['callStatus']=='Online' || $astrologer['callStatus']=='online'): ?>
                                ...
                                <div class="card-info-section">
                                    <a href="<?php echo e(route('front.astrologerDetails', ['id' => $astrologer['id']])); ?>" class="astrologer-name-link">
                                        <h3 class="astrologer-name">
                                            <?php echo e($astrologer['name']); ?>

                                            <?php if(isset($astrologer['isVerified']) && $astrologer['isVerified']): ?>
                                    ...
                                    <p class="astrologer-specialties">
                                        <?php echo e($astrologer['allSkill'] ?? 'Vedic Astrology'); ?>

                                    </p>
                                    
                                    <!-- Languages -->
                                    <p class="astrologer-languages">
                                        <?php echo e($astrologer['languageKnown'] ?? 'Hindi, English, Telugu'); ?>

                                    </p>
                                    
                                    <!-- Experience -->
                                    <p class="astrologer-experience">
                                        Exp. <?php echo e($astrologer['experienceInYears'] ?? 5); ?> years
                                    </p>
                                    
                                    <!-- Price -->
                                    <div class="price-section">
                                        <?php if($isFreeAvailable == true): ?>
                                            <span class="price-striked"><?php echo e($currency['value']); ?><?php echo e($astrologer['charge']); ?>/Min</span>
                                            <span class="free-badge">Free</span>
                                        <?php else: ?>
                                            <span class="price-current"><?php echo e($currency['value']); ?><?php echo e($astrologer['charge']); ?>/Min</span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="rating-section">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <?php if($i <= floor($astrologer['rating'] ?? 4.5)): ?>
                                        ...
                                        <span style="margin-left: 5px; color: #2c1f0f; font-size: 13px; font-weight: 600;">
                                            <?php echo e(number_format($astrologer['rating'] ?? 4.9, 1)); ?> (<?php echo e(number_format($astrologer['reviews'] ?? 3024)); ?>)
                                        </span>
                                    </div>
                                    
                                    <!-- Call Button -->
                                    <div class="call-button-section">
                                        <?php if($astrologer['callStatus']=='Busy' || $astrologer['callStatus']=='Offline' || empty($astrologer['callStatus']) || ($astrologer['callStatus'] != 'Online' && $astrologer['callStatus'] != 'online')): ?>
                                        ...
                                        <?php else: ?>
                                            <a class="btn-call-active" 
                                               ...
                                               id="audio-call-btn"
                                               onclick="setAstrologerData(<?php echo e($astrologer['id']); ?>, <?php echo e($astrologer['charge']); ?>)">
                                                Call Now
                                            </a>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\www\bunny\astrosaar\resources\views/frontend/pages/astrologer-call-list.blade.php ENDPATH**/ ?>